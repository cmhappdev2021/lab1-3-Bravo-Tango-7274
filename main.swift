...
print(averageHRD)
print("This does differ because the average of the heart rates were not an exact digit so it rounded down, but now that they are doubles, it gave the exact decimal")
...
let heartRate_2 = 81
let heartRate_3 = 99
let averageHeartRate = (heartRate_1+heartRate_2+heartRate_3)/3
